...
export const metadata: Metadata = {
  title:
    "Sheetal Bhardwaj - Portfolio Website",
  description:
  ...
  authors: [{ name: "Sheetal Bhardwaj" }],
  creator: "Sheetal Bhardwaj",
  publisher: "Sheetal Bhardwaj",
  ...
  openGraph: {
    ...
    title: "Sheetal Bhardwaj - Portfolio Website for a Full Stack Developer",
    description:
      "Personal portfolio showcasing skills, projects, experience, and more. Built with modern web technologies.",
    siteName: "Sheetal Bhardwaj Portfolio",
  },
  twitter: {
